<template>
  <div class="all">
    ...
    <div class="other">
      <Info str="公司信息" refs="rippleOne" fa="fa fa-building fa-2x" />
      <Info str="排名" refs="rippleTwo" fa="fa fa-line-chart fa-2x" />
      <Info str="规则查询" refs="rippleOne" fa="fa fa-comment-o fa-2x" />
